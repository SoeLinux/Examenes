...
- Realiza el update y el upgrade de la misma
- Instala docker y el modulo de pyton para trabajar con los contenedores
- Levanta el servicio de docker
- Crea un contenedor de **codiad**, que es un ID echo en JS. ( de ejemplo ) 
...
github: https://github.com/SoeLinux/Examene2.git
```
